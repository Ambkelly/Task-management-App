            ...
            <main className="main_container">
                ...
                <div className="Second_row">
                    <div className="columns first_col">
                        ...
                        <h3>{tasks ==""? "First Task" : tasks[0]}</h3>
                        <p>Designing</p>
                    ...
                    <div className="columns first_col second_col">
                        ...
                        <h3>{tasks =="" && {tasks}? "Second Task" : tasks[1]}</h3>
                        <p>Shopping</p>
                        <div className="outter_progress">
                        ...
                        <div className="last_section"> 
                            ...
                            <span className="days_left days_left_two">
                                3 days left
                            </span>
                        </div>
                    </div>
                    <div className="columns first_col">
                        <p className="title">Nov 2, 2022</p>
                        <h3>{tasks =="" ? "Third Task" : tasks[2]}</h3>
                        <p>Designing</p>
                        <div className="outter_progress">
                        ...
                        <div className="last_section"> 
                            ...
                            <span className="days_left days_left_three">
                                3 days left
                            </span>
                        </div>
                    </div>
            ...
            <div className="Right_aside_container">
                <div className="current_task">
                    ...
                    <div className="profile">
                        <span>
                            <img src="Group 21 2.png" alt="Prifile_icon" />
                        </span>
                    ...
                    <div className="Add_task">
                        ...
                        <p>
                            View your current Task so as to stay updated
                        </p>
                        <div className="Task_display">
                            <p>
                                 {tasks =="" ? "Current Task" : tasks[0]}
                            </p>
                        </div>
                    </div>
